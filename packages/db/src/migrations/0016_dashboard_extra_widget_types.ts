export const dashboardExtraWidgetTypesSql = `
...
create table dashboard_widgets (
  ...
  type text not null check (type in ('saved_view', 'today', 'upcoming', 'overdue', 'favorites', 'recent_activity', 'project_health', 'timeline', 'calendar', 'web', 'pomodoro', 'static_text')),
  title text,
