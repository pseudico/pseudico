# PSE-249 — Contact detail route fix evidence
...
- Change: related contact cards expose an `Open contact` action and contact search destinations now route to `/contacts/:contactId`.
- Evidence: `docs/manual-qa/screenshots/PSE-249-contact-detail-route-fix/contact-direct-dj-deriu.png`; `docs/manual-qa/screenshots/PSE-249-contact-detail-route-fix/project-relationship-open-contact.png`.
- Tests: `packages/ui/tests/contactComponents.test.tsx`; `packages/features/tests/searchService.test.ts`.
